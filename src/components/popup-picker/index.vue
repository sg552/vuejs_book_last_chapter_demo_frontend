        ...
        <div class="vux-popup-picker-container">
          <div class="vux-popup-picker-header" @touchmove.prevent>
            <flexbox>
              ...
              <flexbox-item class="vux-popup-picker-header-menu vux-popup-picker-header-menu-right" @click.native="onHide(true)">确定</flexbox-item>
            </flexbox>
          </div>
          <picker
          :data="data"
...
export default {
  ...
  watch: {
    ...
    currentValue (val) {
      console.info("== in currentValue, val: "  + val)
      this.$emit('on-change', getObject(val))
      this.$emit('input', getObject(val))
    },
    show (val) {
      this.showValue = val
      this.$emit('change', getObject(val))
    }
  },
  data () {
    return {
...
.vux-popup-picker-select-box:after {
  content: " ";
  display: inline-block;
